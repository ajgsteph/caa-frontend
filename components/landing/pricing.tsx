        ...
        <section className="py-24">
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
                ...
                <Card className="relative overflow-hidden bg-secondary border-none rounded-none p-2">
                    {/* Coins décoratifs */}
                    <div className="absolute top-4 left-4 w-6 h-6 border-t border-l border-cert-terra" />
                    <div className="absolute bottom-4 right-4 w-6 h-6 border-b border-r border-cert-terra" />

                    <CardContent className="p-8 md:p-10">
                        <div className="text-sm font-medium text-cert-terra mb-4">Par certificat</div>
