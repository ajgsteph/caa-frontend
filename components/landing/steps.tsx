    ...
    return (
        <section id="how" className="py-20 bg-secondary/90">
            <div className="container">
                <div className="text-xs tracking-widest uppercase text-caa-terra font-semibold mb-4">Trois étapes</div>
                <h2 className="text-4xl md:text-5xl font-semibold tracking-wide max-w-2xl mb-16">
                    Du pinceau au certificat, en <em className="text-caa-terra">quelques minutes</em>.
                </h2>

                <div className="grid md:grid-cols-3 gap-10">
                    {steps.map((step) => (
                        <div key={step.num} className="pt-8 border-t border-border/50">
                            <div className="italic text-5xl text-caa-terra mb-6 leading-none">{step.num}</div>
